 ...
 */
public class ComputeNode extends HypercubeNode
{
    /**
...
//        }
    ...
    /**
     * Returns a list with the ids of all the neighbors of this node, whose state is Ok.
     *
     * @return
     */
    ...
    /**
     * Returns a list with the ids of all the neighbors of this node, whose state is Underutilized.
     *
     * @return
     */
    ...
    /**
     * Returns a list with the ids of all the neighbors of this node, whose state is Idle.
     *
     * @return
     */
    ...
    /**
     * Returns a list with the ids of all the neighbors of this node, whose state is SwitchedOff.
     *
     * @return
     */
