...
public class Environment
{
	...
	/** indicates whether to package VM instances (simulate VM dependencies) or not */
    private Boolean packageVmInstances;

    /** initial number of idle compute nodes upon startup */
    private Integer initialClusterSize;

    /** Indicates whether to use random UUIDs or sequential numeric IDs for compute nodes and vm instances */
