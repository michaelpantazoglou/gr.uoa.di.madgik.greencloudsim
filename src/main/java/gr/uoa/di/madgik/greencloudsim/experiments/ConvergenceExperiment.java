...
/**
 * Implements the convergence experiment. With this experiment, we want to
 * assess how fast the datacenter converges to a state where its energy
 * consumption is reduced and no more VM migrations are needed.
 *
