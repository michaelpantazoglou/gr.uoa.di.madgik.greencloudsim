...
public abstract class CloudSimulator
{
    ...
    /**
     * Sets the cloud's initial workload (i.e., distributes a number of VM instances to the cloud's compute nodes).
     * @throws Exception
     */
    protected abstract void setInitialWorkload() throws Exception;

    /**
     * Updates the cloud's workload by either adding or removing VM instances to/from the cloud's compute nodes.
     * @param round
     * @throws Exception
     */
