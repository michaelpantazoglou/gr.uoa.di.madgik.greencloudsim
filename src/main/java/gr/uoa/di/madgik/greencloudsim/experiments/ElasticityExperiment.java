...
/**
 * Implements the elasticity experiment. The goal of this experiment is to assess
 * the ability of the datacenter to scale up and down (i.e. to switch on and off compute nodes)
 * in response to changes in the workload (i.e. increase/decrease of number of vm instances).
 *
